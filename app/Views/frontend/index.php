...
<div class="page">
	<div class="page-main h-100">
        ...
        <!--Section-->
        <div class="banner-1 cover-image bg-background2 bg-white" data-bs-image-src="../../assets/images/banners/pattern.png">
            <!--Topbar-->
                ...
                <div class="horizontal-main header-style1  bg-dark-transparent clearfix">
                    <div class="horizontal-mainwrapper container clearfix">
                        <div class="desktoplogo">
                            <a href="index.html"><img src="../../assets/images/brand/logo.png" alt="img">
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-7 col-md-12">
                                <div class="text-body mb-7">
                                    <h1 class="mb-1 leading-tight ">School Lunch Digital Learning</h1>
                                    <p>สร้างสุขภาวะที่ดีทางด้านอาหารและโภชนาการ</p>
                                </div>
                                <div class="search-background bg-transparent">
                                    <div class="form row g-0 ">
                                        <div class="form-group  col-xl-9 col-lg-9 col-md-12 mb-0">
                                            <input type="text" class="form-control input-xl ps-5 border-white-1" placeholder="ค้นหาหลักสูตร...." data-min-length="1" list="courses" name="courses">
                                        </div>
                                        <div class="col-xl-3 col-lg-3 col-md-12 mb-0">
                                            <a href="javascript:void(0)" class="btn btn-xl btn-block btn-primary br-ts-md-0 br-bs-md-0">ค้นหา</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-5 col-lg-5 col-md-12">
                                <img src="../../assets/images/banners/main.png" class="main-banner-png" alt="img">
                            </div>
                        </div>
                    </div>
                </div><!-- /header-text -->
            ...
            <div class="container">
                ...
                <div id="myCarousel1" class="owl-carousel owl-carousel-icons2">
                    <div class="item">
                        <div class="card mb-0 overflow-hidden">
                            <div class="card-body">
                                ...
                                <img src="../../assets/images/media/color/sm/6.jpg" alt="img" class="w-9 h-9 br-7 mb-4">
                                <div class="">
                    ...
                    <div class="item">
                        <div class="card mb-0 overflow-hidden">
                            <div class="card-body">
                                <img src="../../assets/images/media/color/sm/7.jpg" alt="img" class="w-9 h-9 br-7 mb-4">
                                <div class="">
                                    <div class="item-card2">
                                        <div class="item-card2-desc">
                                            <div class="d-inline-flex">
                    ...
                    <div class="item">
                        <div class="card mb-0 overflow-hidden">
                            <div class="card-body">
                                <img src="../../assets/images/media/color/sm/8.jpg" alt="img" class="w-9 h-9 br-7 mb-4">
                                <div class="">
                                    <div class="item-card2">
                                        <div class="item-card2-desc">
                                            <div class="d-inline-flex">
                    ...
                    <div class="item">
                        <div class="card mb-0 overflow-hidden">
                            <div class="card-body">
                                <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><img src="../../assets/images/png/power.png" class=""></span></div>
                                <img src="../../assets/images/media/color/sm/2.jpg" alt="img" class="w-9 h-9 br-7 mb-4">
                                <div class="">
                                    <div class="item-card2">
                                        <div class="item-card2-desc">
                                            <div class="d-inline-flex">
                    ...
                    <div class="item">
                        <div class="card mb-0 overflow-hidden">
                            <div class="card-body">
                                <img src="../../assets/images/media/color/sm/3.jpg" alt="img" class="w-9 h-9 br-7 mb-4">
...
<script src="<?=base_url()?>/assets/plugins/jquery.flexdatalist/jquery.flexdatalist.js"></script>
<script src="<?=base_url()?>/assets/plugins/jquery.flexdatalist/data-list.js"></script>
